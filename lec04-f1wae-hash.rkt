...
;; implementation of deferred substitution with plai hash maps
;; the interface is the same as for the implementation with
;; the hand-crafted linear datastructure
(define (mtSub) (hash))
...
;; this lookup is simply fetching data from the hash map
;; instead of linearly searching for it 
